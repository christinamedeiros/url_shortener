...
class ShortnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shortner" do
    assert_difference('Shortner.count') do
      post shortners_url, params: { shortner: { long_url: @shortner.long_url, short_url: @shortner.short_url } }
    end
  ...
  test "should update shortner" do
    patch shortner_url(@shortner), params: { shortner: { long_url: @shortner.long_url, short_url: @shortner.short_url } }
